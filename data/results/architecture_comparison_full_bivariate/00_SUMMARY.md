...
- [q1_religion_politics](./q1_religion_politics.md) — How do religion and politics relate in Mexico?
- [q2_environment_economy](./q2_environment_economy.md) — How do Mexicans balance environmental concerns with economic development?
- [q3_education_poverty](./q3_education_poverty.md) — What relationship do Mexicans see between education and poverty?
- [q4_gender_family](./q4_gender_family.md) — How are gender roles changing in the Mexican family?
- [q5_migration_culture](./q5_migration_culture.md) — How does migration affect Mexican cultural identity?
- [q6_health_poverty](./q6_health_poverty.md) — How does health access relate to poverty in Mexico?
- [q7_democracy_corruption](./q7_democracy_corruption.md) — What do Mexicans think about the relationship between democracy and corruption?
- [q8_indigenous_discrimination](./q8_indigenous_discrimination.md) — How do Mexicans perceive discrimination against indigenous peoples?
- [q9_technology_education](./q9_technology_education.md) — How does technology impact education according to Mexicans?
- [q10_security_justice](./q10_security_justice.md) — What relationship do Mexicans see between public security and justice?
